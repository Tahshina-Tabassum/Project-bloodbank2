...
if($filename!=""){
$sql="UPDATE  `admin` set `Name`='$name',`Department`='$department',`phone_number`='$phone_number',`last_donate`='$date',`email`='$email',`image`='$destinationfile',`blood_group`='$blood_group' WHERE username='$username'";
