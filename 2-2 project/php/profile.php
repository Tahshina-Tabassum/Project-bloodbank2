        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card text-center sidebar">
                    ...
                    <!-- <img src="mypic2.jpg" class="rounded-circle" > -->
                    <div class="button_req">
                       <a href="patientdetails.php"> <button class="btn-n1">Request for blood</button></a>
                        <a href="donar_search.php"><button class="btn-n2">See available doner</button></a>
