...
<body>
    ...
    <div class="container1">
        <div class="row">
            <div class="col col1">
                ...
                <h1 id="tform">Login as a<span>  User</span></h1>
                <form method="post">
                <h3>User Name<span>*</span></h3>
                <input class="username" type="text" name="username" id="username"><br><br>
                <h3>Email<span>*</span></h3>
                <input class="email" type="email" name="email" id="email"><br><br>
                <h3>Password<span>*</span></h3>
                <input class="Password" type="password" name="password" id="password"><br><br>
                <br>
                
                 <input type="submit" 
                class="btn" value="Submit it" />
                </form> 
    ...
    <div class="map">
        ...
        <iframe
            ...
            width="95%" height="250" style="border:0;" allowfullscreen="" loading="lazy"
...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
 //   header('location: profile.php');
   // echo "hi";
    ...
    $email=$_POST['email'];
    $sql="SElECT * FROM `donar` WHERE username='$username' and password='$password' and email='$email'";
